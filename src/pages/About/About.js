    ...
    return (
        <>
            <main className="container-fluid py-2 pb-3">
                ...
                <Text class="text-center text-about" text="O antiquário Velho Luxo nasceu em 2021, com o intuito de facilitar o acesso a peças antigas àquOeles que as amam.Surgindo assim um e-commerce, que abrange todo território nacional, e com foco na qualidade e atendimento ao cliente."/>
                ...
                <Text class="text-center text-about" text= "Oferecemos atendimento personalizado com profissionais experientes e qualificado para satisfazer e dar o melhor  a cada cliente."/>
